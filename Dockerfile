...
RUN pip install mysql-python dash gunicorn uproot==4.1.1 h5py peakutils plotly pymongo sphinx sphinx_rtd_theme numpydoc pandas six DateTime importlib-metadata
# Install NuRadioReco
