...
from NuRadioReco.detector.webinterface.utils.helper_station import input_station_information, input_channel_information, build_collection_input, validate_station_inputs, validate_channel_inputs, insert_general_station_info_to_db, insert_general_channel_info_to_db
...
def build_main_page(main_cont):
    ...
    selected_channel, selected_antenna_name, selected_antenna_type, comm_date_ant, decomm_date_ant, signal_chain_ant, cha_comment, function_channel = input_channel_information(cont_channel, selected_station_id, collection_name, station_info)
    ...
    insert_channel_info(collection_name, cont_channel_warning, cont_warning_bottom, selected_station_id, selected_channel, signal_chain_ant, selected_antenna_name, selected_antenna_type, cha_comment, comm_date_ant, decomm_date_ant, station_info)
