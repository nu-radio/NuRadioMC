...
def load_cable_response(cable_length, path="/vol/astro7/lofar/kterveer/software/NuRadioMC/NuRadioReco/detector/LOFAR/signalchain"):
    """
    Parameters
    ----------
    path: string
    ...
    data = np.loadtxt(f"/vol/astro7/lofar/kterveer/software/NuRadioMC/NuRadioReco/detector/LOFAR/signalchain/attenuation_RG58_{cable_length}m.txt")
    default = {}
    default['frequencies'] = np.arange(30,80) * units.MHz
    default['gain'] = -1*hp.dB_to_linear((data)) * units.dB   #cable loss is negative. data is in dB
    return default
...
def load_RCU_response(path="/vol/astro7/lofar/kterveer/software/NuRadioMC/NuRadioReco/detector/LOFAR/signalchain"):
    """
    Parameters
    ----------
    path: string
    ...
    data = np.loadtxt("/vol/astro7/lofar/kterveer/software/NuRadioMC/NuRadioReco/detector/LOFAR/signalchain/RCU_gain_new_5.txt")
    default = {}
    default['frequencies'] = np.arange(30,80) * units.MHz
...
def get_RCU_response(frequencies, cable_length):
