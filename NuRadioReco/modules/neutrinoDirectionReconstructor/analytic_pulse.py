"""
Module to create (simulated) neutrino pulses

This module creates 'mini'-simulations of neutrino pulses convolved with
a detector response. It is mostly used in the forward-folding fit
of `NuRadioReco.modules.neutrinoDirectionReconstructor.neutrinoDirectionReconstructor`.
...
class simulation():
    ...
    def begin(
        ...
        systematics : dict | None, default: None
            If not None, modify the used antenna responses.
        ...
        ice_model : string | IceModel instance | None (default)
