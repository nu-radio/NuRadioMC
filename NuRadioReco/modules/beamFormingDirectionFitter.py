...
def get_array_of_channels(station, det, zenith, azimuth, polarization,time_domain=False): # pol 1 is vpol
...
class beamFormingDirectionFitter:
	...
	def run(self, evt, station, det, polarization, n_index=None,channels=[4,5,6,7], ZenLim=[90 * units.deg, 180 * units.deg],
		...
		AziLim: 2-dim array/list of floats
			...
			default is 0-360deg
		time_offsets: 2-dim array/list of length "channels".
			Adds additional user made time offset to channels.
		"""
