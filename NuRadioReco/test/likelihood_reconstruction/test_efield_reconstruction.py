...
np.testing.assert_almost_equal(efield_reco[efp.polarization_angle] / units.degree % 180, reference_polarization, decimal=1)
np.testing.assert_almost_equal(efield_reco.get_parameter_error(efp.polarization_angle) / units.degree, reference_polarization_error, decimal=1)