...
for thetamin, thetamax in zip(thetamins, thetamaxs):
	...
	for flavour in flavours:
		...
		for folder, Emin, Emax in zip(folderlist, Emins, Emaxs):
			...
			print(outname)
			generate_eventlist_cylinder(outname, nevt, Emin, Emax, volume, thetamin=thetamin, thetamax=thetamax,
									phimin=phimin, phimax=phimax, start_event_id=1, flavor=[flavour],
									n_events_per_file=nevt_perfile, deposited=True)
