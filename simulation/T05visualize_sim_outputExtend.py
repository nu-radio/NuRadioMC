...
weightsExt = weights
for chan in range(1, len(fin['launch_vectors'][0])):
...
plt.subplot(2, 1, 1)
plt.hist([dCherenkov_d[mask_d], dCherenkov_r[mask_r]], weights = [weightsExt[mask_d],  weightsExt[mask_r]], bins = np.arange(-20, 20, 1))
