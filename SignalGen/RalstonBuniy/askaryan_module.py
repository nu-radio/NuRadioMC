...
def get_frequency_spectrum(energy, theta, freqs, is_em_shower, n, R, LPM=True, a=None):
    if(a is None):
        a = 0
...
def get_time_trace(energy, theta, freqs, is_em_shower, n, R, LPM=True, a=None):
    eR, eTheta, ePhi = get_frequency_spectrum(energy, theta, freqs, is_em_shower, n, R, LPM, a)
