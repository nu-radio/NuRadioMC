...
The code consists of 4 core modules that handle different parts of the reconstruction:
  ...
  - :code:`NuRadioReco.modules.likelihood_reconstruction.likelihood_calculator.LikelihoodCalculator`: Calculates the likelihood
  ...
  - :code:`NuRadioReco.modules.likelihood_reconstruction.shower_simulator.ShowerSimulator`: Simulates the signal traces from a
    ...
    signals.
  - :code:`NuRadioReco.utilities.minimization.Minimization`: Class for minimization of, e.g., a -2 log likelihood that unifies
    the interfaces of :code:`scipy.optimize` and :code:`iminuit`. The class adds additional functionality like normalization
    of the fitted parameters.
  - :code:`NuRadioReco.utilities.matched_filter.MatchedFilter`: Class for performing a matched filter search of simulated signal
    templates in noisy data. The class is initialized with the spectra of the noise in each antenna. This is
    a useful method to identify signal traces from backgrounds in an event-selection. It is also used in reconstruction
...
These modules are then combined in modules for specific reconstruction tasks with easy-to-use interfaces:
  ...
  - :code:`NuRadioReco.modules.likelihood_reconstruction.neutrinoLikelihoodReconstructor`: Reconstructs a neutrino
  ...
  - :code:`NuRadioReco.modules.likelihood_reconstruction.electricFieldLikelihoodReconstructor`: Reconstructs a pulsed
...
The :code:`neutrinoLikelihoodReconstructor` reconstructs the parameters of a shower from a neutrino signal given a set of measured traces.
