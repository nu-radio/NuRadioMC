...
def test_equal_station_keys(keys, fin1=fin1, fin2=fin2, error=error):
    for key in keys:
        try:
            ...
            print("eference: {}, reconstruction: {}".format(fin2[key], fin1[key]))
            print(e)
            error += 1
    return error
...
keys = [u'maximum_amplitudes', u'time_shower_and_ray']
