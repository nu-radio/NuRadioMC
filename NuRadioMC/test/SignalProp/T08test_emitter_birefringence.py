...
# The tolerance was chosen to be 0.001V. The amplitudes of the pulses are above 1V.
...
testing.assert_allclose(traces, reference_array, atol=0.001  * units.V, rtol=1e-7)
