...
std::vector<std::vector<float> >* Askaryan::E_t(){
	...
	fftw_plan p1,p2,p3;
	p1 = fftw_plan_dft_1d(n,in1,out1,FFTW_BACKWARD,FFTW_ESTIMATE);
	p2 = fftw_plan_dft_1d(n,in2,out2,FFTW_BACKWARD,FFTW_ESTIMATE);
	p3 = fftw_plan_dft_1d(n,in3,out3,FFTW_BACKWARD,FFTW_ESTIMATE);
