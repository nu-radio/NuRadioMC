...
if __name__ == "__main__":
    ...
    arz = ARZ()
    vp = arz.get_vector_potential(energy, theta, N, dt, y, 'cc', flavor, n_index, R, profile_depth=depth_e, profile_ce=(N_e - N_p))
    arz2 = ARZ()
    vp2 = arz2.get_vector_potential(energy, theta, N, dt, y, 'nc', n_index, R, profile_depth=depth_e, profile_ce=(N_e - N_p))
    ...
    shower_type = 'EM'
    trace = arz.get_time_trace(energy, theta, N, dt, shower_type, n_index, R)
