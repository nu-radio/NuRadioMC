...
if numba_available:
    @jit(nopython=True)
    def get_vector_potential_numba(shower_energy, theta, N, dt, profile_depth, profile_ce,
        ...
        """
        --- Numba version of the python implementation ---
...
class ARZ(object):
    ...
    def __init__(self, seed=1234, interp_factor=1, interp_factor2=100, library=None,
        ...
        if use_numba & (not numba_available):
            logger.warning('Numba unavailable, using Python implementation instead.')
    ...
    def get_time_trace(self, shower_energy, theta, N, dt, shower_type, n_index, R, shift_for_xmax=False,
        ...
        if self._use_numba:
            ...
            if shower_type == "HAD":
                ...
                logger.warning("Shower type {} not implemented in numba! Trying Python implementation...")
        ...
        if (not self._use_numba) or fallback_python:
