...
void colz_rayM(){
  ...
  hist2dReD->Draw("colz");
  hist2dReD->SetTitle("Time of Reflected Ray-Direct Ray , Receiver at z=-2 m, x=1000 m, Step size=50;X (m);Z (m); Time (ns)");
  ...
  hist2dRaD->Draw("colz");
  hist2dRaD->SetTitle("Time of Refracted ray-Direct Ray , Receiver at z=-2 m, x=1000 m, Step size=50 m;X (m) ;Z (m); Time (ns)");
  ...
  hist2dD->SetStats(0);
  hist2dD->Draw("colz");
  hist2dD->SetTitle("Time of Direct Ray , Receiver at z=-2 m, x=1000 m, Step size=50 m;X (m) ;Z (m); Time (ns)");
  ...
  hist2dD_ang->SetTitle("Launch angle of Direct Ray , Receiver at z=-2 m, x=1000 m, Step size=50 m;X (m) ;Z (m); Time (ns)");
