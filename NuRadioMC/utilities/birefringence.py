"""
This module contains helper functions to calculate the effective refractive indices and the polarization vectors for a birefringent medium.

Birefringent describes the phenomena when the refractive index of a medium depends on the signal polarization. The calculations are described here: 
